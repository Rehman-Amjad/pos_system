                                ...
                                child: DropdownButton2<String>(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      ...
                                      widget.formControllers.itemNameController
                                          .text = value!;
                                      widget.formControllers.itemNameController
                                          .text = value;
                                      widget.formControllers.itemCodeController
                                          .text = provider.itemsID[itemIndex];
                                      widget.formControllers.uomController
                                          .text = provider.uom[itemIndex];
                                      widget.formControllers.stockController
                                          .text = provider.itemStock[itemIndex];
                                      widget.formControllers.saleRateController
                                              .text =
                                          provider.itemSalePrice[itemIndex];
                                      widget.formControllers.priceRateController
                                              .text =
                                          provider.itemPurchasePrice[itemIndex];
                                      updateAmount();
                                      updateTotal();
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: widget
                        ...
                        ? widget.formControllers.quantityController.text = '1'
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: widget
                            .formControllers.totalAmountController.text.isEmpty
                        ? widget.formControllers.discountController.text = '0'
