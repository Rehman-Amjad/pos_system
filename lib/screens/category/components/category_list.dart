        ...
        StreamBuilder(
          ...
          builder: (context, snapshot){
            ...
            Container(
              ...
              child: Center(child: Text("No Category Found",style: TextStyle(
            ...
            Container(
              ...
              child: PaginatedDataTable(
                  header: TextWidget(text: "Total Category: ${snapshot.data!.docs.length}",size: 20,color: Colors.white, isBold: false,),
...
class DataTableSourceImpl extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    return DataRow.byIndex(
      ...
      cells: [
        DataCell(
          TextWidget(text: category[index][Constant.KEY_CATEGORY_ID].toString(), color: Colors.white,
            ...
            Row(
              children: [
                ...
                Padding(
                  ...
                  child: TextWidget(text: category[index][Constant.KEY_CATEGORY_NAME].toString(), color: Colors.white,
                    size: 14.0, isBold: false,),),
              ],
            )
        ),
        DataCell(
          TextWidget(text: category[index][Constant.KEY_CATEGORY_DESC].toString(), color: Colors.white,
            size: 14.0, isBold: false,),
        ),
        const DataCell(
