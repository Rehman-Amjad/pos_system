  ...
  Future<void> uploadRegistrationData({
    ...
    try {
      await firestore.collection(collection).doc(count.toString()).set({
        ...
        Constant.KEY_ITEM_NAME: name.toString().toUpperCase(),
        Constant.KEY_ITEM_CATEGORY: category.toString().toUpperCase(),
        Constant.KEY_ITEM_UOM: uom.toString().toUpperCase(),
