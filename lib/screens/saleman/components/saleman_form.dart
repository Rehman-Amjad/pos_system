    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                TextHelper().mNormalText(
                    text: "Sales Man Code: ", color: Colors.white, size: 14.0),
            ...
            TextHelper().mNormalText(
                text: "Sales Man Phone", color: Colors.white, size: 14.0),
            const SizedBox(
              height: 15.0,
            ),
            Container(
            ...
            TextHelper().mNormalText(
                text: "Sales Man Address", color: Colors.white, size: 14.0),
            const SizedBox(
              height: 15.0,
            ),
            Container(
                    ...
                    ? ButtonWidget(
                        ...
                        onClicked: () {
                          if (nameController.text.isNotEmpty &&
                            ...
                            Get.snackbar("Sales Man Updated...", "",
                    ...
                    : ButtonWidget(
                        ...
                        onClicked: () {
                          if (nameController.text.isNotEmpty &&
                            ...
                            Get.snackbar("New Sales Man Added", "",
                                backgroundColor: hoverColor,
                                colorText: Colors.white);
                          } else {
                            Get.snackbar(
